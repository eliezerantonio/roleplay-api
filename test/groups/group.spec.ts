...
test.group('Group', (group) => {
  ...
  test('it should return  groups by user id', async (assert) => {
    const groupPayload = {
      name: 'test',
      description: 'test',
      schedule: 'test',
  ...
  test('it should return  groups by user by id and name', async (assert) => {
    const groupPayload = {
      name: 'test',
      description: 'test',
      schedule: 'test',
  ...
  test('it should return  groups by user by name', async (assert) => {
    const groupPayload = {
      name: 'test',
      description: '123',
      schedule: 'test',
  ...
  test('it should return  groups by user id and description', async (assert) => {
    const groupPayload = {
      name: 'test',
      description: 'test',
      schedule: 'test',
  ...
  test('it should return  groups by user by description', async (assert) => {
    const groupPayload = {
      name: '124',
      description: 'test',
      schedule: 'test',
